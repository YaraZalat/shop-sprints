...
import '../constants/app_key_constant.dart';

abstract class Validator {
  static String? validateEmail(String? val) {
    final RegExp emailRegex = RegExp(AppKeyConstant.emailRegex);
  ...
  static String? validatePassword(String? val) {
    final RegExp passwordRegex = RegExp(AppKeyConstant.passwordRegex);
